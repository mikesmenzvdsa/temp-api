...
class ReservationsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $allBodyCorps = DB::table('virtualdesigns_bodycorp_bodycorp')->whereNull('deleted_at')->get();
    ...
    public function reservations(string $page)
    {
        if (view()->exists("pages.reservations.{$page}")) {
            ...
            if ($page == 'dashboard') {
                $today_arrival_date = DB::table('virtualdesigns_erpbookings_erpbookings as booking')->where('arrival_date', '=', $today)
                ...
                $today_departure_date = DB::table('virtualdesigns_erpbookings_erpbookings as booking')->where('departure_date', '=', $today)
                    ->where('booking.status', '!=', 1)
                    ->where('booking.deleted_at', '=', null)
                    ->where('booking.quote_confirmed', '=', 1)
                    ->count();

                $msc = DB::table('virtualdesigns_erpbookings_erpbookings as booking')->join('virtualdesigns_cleans_cleans as cleans', 'cleans.booking_id', '=', 'booking.id')
                    ->where('booking.status', '!=', 1)
                    ->where('booking.deleted_at', '=', null)
                    ->where('booking.quote_confirmed', '=', 1)
                    ...
                    ->count();
                $today_reservations_count = DB::table('virtualdesigns_erpbookings_erpbookings as booking')->whereBetween('date_confirmed', [
                ...
                $tomorrow_reservations_count = DB::table('virtualdesigns_erpbookings_erpbookings as booking')->where('arrival_date', '=', date('Y-m-d', strtotime('+1 day')))
                    ->where('booking.status', '!=', 1)
                    ->where('booking.deleted_at', '=', null)
                    ->where('booking.quote_confirmed', '=', 1)
                    ->count();

                $reported_issues = DB::table('virtualdesigns_reportedissues_issues as issues')
                ...
                $reported_issues_in_progress_last_seven_days_count = DB::table('virtualdesigns_reportedissues_issues as issues')
                    ->join('virtualdesigns_properties_properties as property', 'issues.property_id', '=', 'property.id')
                    ->whereNull('issues.deleted_at')
                    ->whereNotNull('issues.date_booked')
                    ->where('issues.date_booked', '<>', '')
                ...
                $reported_issues_completed_last_seven_days_count = DB::table('virtualdesigns_reportedissues_issues as issues')
                    ->join('virtualdesigns_properties_properties as property', 'issues.property_id', '=', 'property.id')
                    ->whereNull('issues.deleted_at')
                    ->whereNotNull('issues.date_booked')
                    ->where('issues.date_booked', '<>', '')
                ...
                $reported_issues_completed_last_thirty_days_count = DB::table('virtualdesigns_reportedissues_issues as issues')
                    ->join('virtualdesigns_properties_properties as property', 'issues.property_id', '=', 'property.id')
                    ->whereNull('issues.deleted_at')
                    ->whereNotNull('issues.date_booked')
                    ->where('issues.date_booked', '<>', '')
                ...
                $reported_issues_tomorrow = DB::table('virtualdesigns_reportedissues_issues as issues')
                    ->join('virtualdesigns_properties_properties as property', 'issues.property_id', '=', 'property.id')
                    ->whereNull('issues.deleted_at')
                    ->whereNotNull('issues.date_booked')
                    ->where('issues.date_booked', '<>', '')
                ...
                $todays_booking_completed = DB::table('virtualdesigns_erpbookings_erpbookings as booking')
                ...
                $last_seven_days_booking_completed = DB::table('virtualdesigns_erpbookings_erpbookings as booking')
                    ->Leftjoin('virtualdesigns_properties_properties as prop', 'booking.property_id', '=', 'prop.id')
                    ->Leftjoin('virtualdesigns_bodycorp_bodycorp as bodycorp', 'prop.bodycorp_id', '=', 'bodycorp.id')
                    ->Leftjoin('virtualdesigns_erpbookings_guestinfo as guestinfo', 'guestinfo.booking_id', '=', 'booking.id')
                    ->Leftjoin('virtualdesigns_changes_changes as changes', 'changes.record_id', '=', 'booking.id')
                ...
                $todays_booking_incompleted = DB::table('virtualdesigns_erpbookings_erpbookings as booking')
                    ->Leftjoin('virtualdesigns_properties_properties as prop', 'booking.property_id', '=', 'prop.id')
                    ->Leftjoin('virtualdesigns_bodycorp_bodycorp as bodycorp', 'prop.bodycorp_id', '=', 'bodycorp.id')
                    ->Leftjoin('virtualdesigns_erpbookings_guestinfo as guestinfo', 'guestinfo.booking_id', '=', 'booking.id')
                    ->Leftjoin('virtualdesigns_changes_changes as changes', 'changes.record_id', '=', 'booking.id')
                ...
                $last_seven_days_booking_incompleted = DB::table('virtualdesigns_erpbookings_erpbookings as booking')
                    ->Leftjoin('virtualdesigns_properties_properties as prop', 'booking.property_id', '=', 'prop.id')
                    ->Leftjoin('virtualdesigns_bodycorp_bodycorp as bodycorp', 'prop.bodycorp_id', '=', 'bodycorp.id')
                    ->Leftjoin('virtualdesigns_erpbookings_guestinfo as guestinfo', 'guestinfo.booking_id', '=', 'booking.id')
                    ->Leftjoin('virtualdesigns_changes_changes as changes', 'changes.record_id', '=', 'booking.id')
                ...
                return view("pages.reservations.{$page}", [
                    'title' => 'Dashboard',
                ...
                $propertiesWithIds = DB::table('virtualdesigns_properties_properties')
                    ->whereNotNull('bodycorp_id')
                    ->where('bodycorp_id', '!=', 0)->get();

                $prop_recs = DB::table('virtualdesigns_properties_properties')
                ...
                $bookingsCompleted = DB::table('virtualdesigns_erpbookings_erpbookings as booking')
                    ->Leftjoin('virtualdesigns_properties_properties as prop', 'booking.property_id', '=', 'prop.id')
                    ->Leftjoin('virtualdesigns_bodycorp_bodycorp as bodycorp', 'bodycorp.id', '=', 'prop.bodycorp_id')
                    ->Leftjoin('virtualdesigns_erpbookings_guestinfo as guestinfo', 'guestinfo.booking_id', '=', 'booking.id')
                    ->Leftjoin('virtualdesigns_changes_changes as changes', 'changes.record_id', '=', 'booking.id')
                ...
                return view("pages.reservations.{$page}", ['title' => 'Guest Details Collected', 'bookings' => $bookingsCompleted, 'prop_recs' => $prop_recs, 'uniqueBookingRefs' => $uniqueBookingRefs, 'uniqueGuestNames' => $uniqueGuestNames, 'uniqueBodyCorps' => $uniqueBodyCorps, 'bodyCorpDefault' => $bodyCorpDefault, 'date' => $today, 'default_bodycorp' => $defaultCorp, 'allBodyCorps' => $allBodyCorps]);
                ...
                $allbookings = DB::table('virtualdesigns_erpbookings_erpbookings as booking')
                    ->Leftjoin('virtualdesigns_properties_properties as prop', 'booking.property_id', '=', 'prop.id')
                    ->Leftjoin('virtualdesigns_bodycorp_bodycorp as bodycorp', 'prop.bodycorp_id', '=', 'bodycorp.id')
                    ->Leftjoin('virtualdesigns_erpbookings_guestinfo as guestinfo', 'guestinfo.booking_id', '=', 'booking.id')
                    ->Leftjoin('virtualdesigns_changes_changes as changes', 'changes.record_id', '=', 'booking.id')
                ...
                $defaultCorp = $bodyCorpDefault;
                if (isset($message_sent)) {
                    return view("pages.reservations.{$page}", ['title' => 'Sent To Body Corporate', 'message_sent' => $message_sent, 'bookings' => $allbookings, 'prop_recs' => $prop_recs, 'uniqueBookingRefs' => $uniqueBookingRefs, 'uniqueGuestNames' => $uniqueGuestNames, 'uniqueBodyCorps' => $uniqueBodyCorps, 'bodyCorpDefault' => $bodyCorpDefault, 'default_bodycorp' => $defaultCorp, 'allBodyCorps' => $allBodyCorps]);
                } else {
                    return view("pages.reservations.{$page}", ['title' => 'Sent To Body Corporate', 'bookings' => $allbookings, 'prop_recs' => $prop_recs, 'uniqueBookingRefs' => $uniqueBookingRefs, 'uniqueGuestNames' => $uniqueGuestNames, 'uniqueBodyCorps' => $uniqueBodyCorps, 'bodyCorpDefault' => $bodyCorpDefault, 'default_bodycorp' => $defaultCorp, 'allBodyCorps' => $allBodyCorps]);
                }
                ...
                if (isset($message_sent)) {
                    return view("pages.reservations.{$page}", ['title' => 'Past Completed', 'message_sent' => $message_sent, 'bookings' => $allbookings, 'prop_recs' => $prop_recs, 'uniqueBookingRefs' => $uniqueBookingRefs, 'uniqueGuestNames' => $uniqueGuestNames, 'uniqueBodyCorps' => $uniqueBodyCorps, 'bodyCorpDefault' => $bodyCorpDefault, 'default_bodycorp' => $defaultCorp, 'allBodyCorps' => $allBodyCorps, 'thirtyDaysLater' => $thirtyDaysLater, 'yesterday' => $yesterday]);
                } else {
                    return view("pages.reservations.{$page}", ['title' => 'Past Completed', 'bookings' => $allbookings, 'prop_recs' => $prop_recs, 'uniqueBookingRefs' => $uniqueBookingRefs, 'uniqueGuestNames' => $uniqueGuestNames, 'uniqueBodyCorps' => $uniqueBodyCorps, 'bodyCorpDefault' => $bodyCorpDefault, 'default_bodycorp' => $defaultCorp, 'allBodyCorps' => $allBodyCorps, 'thirtyDaysLater' => $thirtyDaysLater, 'yesterday' => $yesterday]);
                }
                ...
                return view("pages.reservations.{$page}", ['title' => 'Past Incompleted', 'bookings' => $allbookings, 'prop_recs' => $prop_recs, 'uniqueBookingRefs' => $uniqueBookingRefs, 'uniqueGuestNames' => $uniqueGuestNames, 'uniqueBodyCorps' => $uniqueBodyCorps, 'bodyCorpDefault' => $bodyCorpDefault, 'default_bodycorp' => $defaultCorp, 'allBodyCorps' => $allBodyCorps, 'thirtyDaysLater' => $thirtyDaysLater, 'yesterday' => $yesterday]);
            } else {
                return view("pages.reservations.{$page}");
            }
        }
    ...
    public function updatereservations(Request $request)
    {
        ...
        if (isset($request->is_filter)) {
            ...
            if (str_contains($routeName, 'collect-guest-details')) {
                return view("pages.reservations.collect-guest-details", ['title' => 'Collect Guest Details', 'filter_values' => $filter_values, 'bookings' => $bookings, 'prop_recs' => $prop_recs, 'uniqueBookingRefs' => $uniqueBookingRefs, 'uniqueGuestNames' => $uniqueGuestNames, 'uniqueBodyCorps' => $uniqueBodyCorps, 'bodyCorpDefault' => $bodyCorpDefault, 'selected_date_properties' => $selected_date_properties, 'default_bodycorp' => $defaultCorp, 'allBodyCorps' => $allBodyCorps]);
            } elseif (str_contains($routeName, 'guest-details-collected')) {
                return view("pages.reservations.guest-details-collected", ['title' => 'Guest Details Collected', 'filter_values' => $filter_values, 'bookings' => $bookings, 'prop_recs' => $prop_recs, 'uniqueBookingRefs' => $uniqueBookingRefs, 'uniqueGuestNames' => $uniqueGuestNames, 'uniqueBodyCorps' => $uniqueBodyCorps, 'bodyCorpDefault' => $bodyCorpDefault, 'selected_date_properties' => $selected_date_properties, 'default_bodycorp' => $defaultCorp, 'allBodyCorps' => $allBodyCorps]);
            } elseif (str_contains($routeName, 'sent-to-body-corp')) {
                return view("pages.reservations.sent-to-body-corp", ['title' => 'Sent To Body Corporate', 'filter_values' => $filter_values, 'bookings' => $bookings, 'prop_recs' => $prop_recs, 'uniqueBookingRefs' => $uniqueBookingRefs, 'uniqueGuestNames' => $uniqueGuestNames, 'uniqueBodyCorps' => $uniqueBodyCorps, 'bodyCorpDefault' => $bodyCorpDefault, 'selected_date_properties' => $selected_date_properties, 'default_bodycorp' => $defaultCorp, 'allBodyCorps' => $allBodyCorps]);
            } elseif (str_contains($routeName, 'past-completed')) {
                return view("pages.reservations.past-completed", ['title' => 'Past Completed', 'filter_values' => $filter_values, 'bookings' => $bookings, 'prop_recs' => $prop_recs, 'uniqueBookingRefs' => $uniqueBookingRefs, 'uniqueGuestNames' => $uniqueGuestNames, 'uniqueBodyCorps' => $uniqueBodyCorps, 'bodyCorpDefault' => $bodyCorpDefault, 'selected_date_properties' => $selected_date_properties, 'default_bodycorp' => $defaultCorp, 'allBodyCorps' => $allBodyCorps]);
            } elseif (str_contains($routeName, 'past-incompleted')) {
                return view("pages.reservations.past-incompleted", ['title' => 'Past Incompleted', 'filter_values' => $filter_values, 'bookings' => $bookings, 'prop_recs' => $prop_recs, 'uniqueBookingRefs' => $uniqueBookingRefs, 'uniqueGuestNames' => $uniqueGuestNames, 'uniqueBodyCorps' => $uniqueBodyCorps, 'bodyCorpDefault' => $bodyCorpDefault, 'selected_date_properties' => $selected_date_properties, 'default_bodycorp' => $defaultCorp, 'allBodyCorps' => $allBodyCorps]);
            }
            ...
            if ($request->collect_guest_details_completed_status == 'on' && count($booking) > 0) {
                ...
                if ($updateRecord) {
                    ...
                    return redirect()->back()->with('message_sent', 'Details already filled in.');
                }
                ...
                return redirect()->back()->with('message_sent', 'Guest Details Successfully Completed');
            } else {
            ...
            if (count($getOldGuestInfo) > 0 && isset($updateData) && count($updateData) > 0) {
                ...
                if ($updatedGuestInfo && isset($request->guest_booking)) {
                    ...
                    return redirect()->back()->with('message_sent', "Successfully Updated Guest Details");
                } else {
                    return redirect()->back()->with('message_sent', "Details already filled in");
                }
            } else {
                ...
                if ($insertGuestInfo) {
                    ...
                    return redirect()->back()->with('message_sent', "Successfully Inserted Guest Details");
                } else {
                    return redirect()->back()->with('message_sent', "Failed To Insert Guest Details");
                }
            }
            ...
            if (isset($getOldGuestInfo[0]->booking_id)) {
                if ($guest_sent_reg['guest_send_email_response'] == "on" && $getOldGuestInfo[0]->completed == 1) {
                    ...
                    return redirect()->back()->with('message_sent', "Success - Moved to 'Sent To Body Corp'");
                }
            }
            return redirect()->back()->with('message_sent', "Failed Moved to 'Sent To Body Corp'");
        } else {
            return redirect()->back();
        }
